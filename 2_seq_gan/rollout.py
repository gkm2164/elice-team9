...
class ROLLOUT(object):
    def __init__(self, lstm, update_rate, word_embedding_matrix):
        ...
        self.start_token_input = self.lstm.start_token_input
        ...
        i, x_t, h_tm1, given_num, self.gen_x = control_flow_ops.while_loop(
            ...
            loop_vars=(tf.constant(0, dtype=tf.int32),
                       tf.nn.embedding_lookup(self.g_embeddings, self.start_token_input), self.h0, self.given_num, gen_x))
    ...
    def get_reward(self, sess, input_x, rollout_num, discriminator):
        ...
        for i in range(rollout_num):
            ...
            for given_num in range(1, self.sequence_length ):
                feed = {self.x: input_x, self.given_num: given_num, self.start_token: self.start_token_input}
